...
for item in data:
    ...
    if quality.upper() == "HIGH" and category:
        ...
        instructions.append({"instruct": prompts[0], "input" : txt, "output" : outputs[0], "source_name" : source_name,
                             "source_url" : source_url, "source_description" : source_description, "script_name" : script_name})
